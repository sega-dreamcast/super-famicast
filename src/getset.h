   ...
   if (GetAddress >= (uint8 *) CMemory::MAP_LAST)
    {
		...
		CPU.PC = GetAddress + (Address & 0xffff); SCHERZO_PRINT("S9xSetPCBase: CPU.PC = GetAddress + (Address & 0xffff);\n");
		return;
    }
    ...
    case CMemory::MAP_PPU:
		...
		CPU.PC = CPU.PCBase + (Address & 0xffff); SCHERZO_PRINT("S9xSetPCBase MAP_PPU: CPU.PC = CPU.PCBase + (Address & 0xffff);\n");
		return;
		
    case CMemory::MAP_CPU:
		CPU.PCBase = Memory.FillRAM;
		CPU.PC = CPU.PCBase + (Address & 0xffff); SCHERZO_PRINT("S9xSetPCBase MAP_CPU: CPU.PC = CPU.PCBase + (Address & 0xffff);\n");
		return;
		
    case CMemory::MAP_DSP:
		CPU.PCBase = Memory.FillRAM - 0x6000;
		CPU.PC = CPU.PCBase + (Address & 0xffff); SCHERZO_PRINT("S9xSetPCBase MAP_DSP: CPU.PC = CPU.PCBase + (Address & 0xffff);\n");
		return;
		
    case CMemory::MAP_SA1RAM:
    case CMemory::MAP_LOROM_SRAM:
		CPU.PCBase = Memory.SRAM;
		CPU.PC = CPU.PCBase + (Address & 0xffff); SCHERZO_PRINT("S9xSetPCBase MAP_SA1RAM: CPU.PC = CPU.PCBase + (Address & 0xffff);\n");
		return;
		
    case CMemory::MAP_BWRAM:
		CPU.PCBase = Memory.BWRAM - 0x6000;
		CPU.PC = CPU.PCBase + (Address & 0xffff); SCHERZO_PRINT("S9xSetPCBase MAP_BWRAM: CPU.PC = CPU.PCBase + (Address & 0xffff);\n");
		return;
    case CMemory::MAP_HIROM_SRAM:
		CPU.PCBase = Memory.SRAM - 0x6000;
		CPU.PC = CPU.PCBase + (Address & 0xffff); SCHERZO_PRINT("S9xSetPCBase MAP_HIROM_SRAM: CPU.PC = CPU.PCBase + (Address & 0xffff);\n");
		return;
		
    case CMemory::MAP_C4:
		CPU.PCBase = Memory.C4RAM - 0x6000;
		CPU.PC = CPU.PCBase + (Address & 0xffff); SCHERZO_PRINT("S9xSetPCBase MAP_C4: CPU.PC = CPU.PCBase + (Address & 0xffff);\n");
		return;
