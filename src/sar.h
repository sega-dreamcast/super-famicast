...
static SCHERZO_INLINE int8 SAR(const int8 b, const int n){
...
static SCHERZO_INLINE int16 SAR(const int16 b, const int n){
...
static SCHERZO_INLINE int32 SAR(const int32 b, const int n){
...
static SCHERZO_INLINE int64 SAR(const int64 b, const int n){
