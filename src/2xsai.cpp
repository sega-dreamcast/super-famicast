...
static SCHERZO_INLINE int GetResult1 (uint32 A, uint32 B, uint32 C, uint32 D,
			      uint32 /* E */)
{
    int x = 0;
    int y = 0;
...
static SCHERZO_INLINE int GetResult2 (uint32 A, uint32 B, uint32 C, uint32 D,
			      uint32 /* E */)
{
    int x = 0;
    int y = 0;
...
static SCHERZO_INLINE int GetResult (uint32 A, uint32 B, uint32 C, uint32 D)
{
    int x = 0;
    int y = 0;
    int r = 0;
...
static SCHERZO_INLINE uint32 INTERPOLATE (uint32 A, uint32 B)
{
    if (A != B)
    {
...
static SCHERZO_INLINE uint32 Q_INTERPOLATE (uint32 A, uint32 B, uint32 C, uint32 D)
{
