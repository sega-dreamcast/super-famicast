...
static SCHERZO_INLINE void S9xLatchCounters (bool force)
{
...
uint8 S9xGetPPU (uint16 Address)
{
	...
	case 0x213E:
		...
		return (PPU.OpenBus1 = (MAX_5C77_VERSION | PPU.RangeTimeOver));
	...
	case 0x213F:
	    ...
	    return ((Settings.PAL ? 0x10 : 0) | (Memory.FillRAM[0x213f] & 0xc0)| MAX_5C78_VERSION) | (~PPU.OpenBus2 & 0x20);
